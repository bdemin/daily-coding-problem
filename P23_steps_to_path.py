...
# possible path, then return null. You can move up, left, down, and right. You cannot
...
# Modified version from: https://medium.com/@nicholas.w.swift/easy-a-star-pathfinding-7e6689c7f7b2
class Node():
